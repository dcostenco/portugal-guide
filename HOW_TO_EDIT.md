...
Посмотрите запись экрана, где показаны все шаги:

📹 [Видео-инструкция (запись экрана)](docs/tutorial/tutorial_video.webp)

🔊 [Аудио-инструкция на русском (MP3, 1 минута)](docs/tutorial/tutorial_audio_ru.mp3)
